...
class OpenRouterProvider(OpenAICompatibleProvider):
    ...
    DEFAULT_HEADERS = {
        "HTTP-Referer": get_env("OPENROUTER_REFERER", "https://github.com/linxule/vox-mcp")
        or "https://github.com/linxule/vox-mcp",
        "X-Title": get_env("OPENROUTER_TITLE", "Vox MCP Server") or "Vox MCP Server",
    }
