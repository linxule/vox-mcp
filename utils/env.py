"""Centralized environment variable access for Vox MCP Server."""
...
def _compute_force_override(values: Mapping[str, str | None]) -> bool:
    raw = values.get("VOX_FORCE_ENV_OVERRIDE")
...
def env_override_enabled() -> bool:
    """Return True when VOX_FORCE_ENV_OVERRIDE is enabled via the .env file."""

    return _FORCE_ENV_OVERRIDE


def get_env(key: str, default: str | None = None) -> str | None:
    """Retrieve environment variables respecting VOX_FORCE_ENV_OVERRIDE."""
